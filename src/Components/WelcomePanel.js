        ...
        return (
            <div className='container2' style={containerStyle}>
                <div className='main' style={mainStyle} >
                    ...
                    <div className='imgContainer'> <img style={avatarStyle} src={this.props.user.avatar} alt="Avatar" /></div>
                    ...
                    <div className='buttonContainer' style={btnContainerStyle}> <Link to="/otherProfile"><button  style={buttonStyle} onClick={this.handleClick}> Edit</button></Link></div>
